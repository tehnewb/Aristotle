...
public class LocaleResource implements RSResource<LocaleData> {

	private static final LocaleData[] data = new LocaleData[60000];

	private final int objectID;
	private final Consumer<LocaleData> callback;

	@Override
	public void finish(LocaleData locale) {
		data[locale.getID()] = locale;
	...
	final void method3287(LocaleData data) {
