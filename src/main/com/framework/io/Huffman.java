...
public class Huffman {
	...
	*/
	 ...
	 */
	public String decompressHuffman(byte[] message, int length) {
		try {
			int charsDecoded = 0;
			int keyIndex = 0;
	 ...
	 * @param startOffset The start offset from where to write to the destination
	 *                    array.
	 * @return The number of bytes written.
	 */
	public int huffmanCompress(String text, byte[] dest, int startOffset) {
		try {
			int key = 0;
